...
export const VISION_LOADING_MSGS = [
  "プロファイルを参照中…",
  "あなたの軸から判断中…",
  "最善手を探している…",
  "タスクを構成中…",
...
export const PRO_FOLLOW_UPS = ["次のステップは?", "別の視点で見ると?", "優先順位を整理して", "もっと具体的に教えて", "今日中にやるべきことは?"];
export const VISION_FOLLOW_UPS = ["次に取り組むことは?", "軌道修正するには?", "今日の最優先は?", "もっとシンプルにするには?"];
