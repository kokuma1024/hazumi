...
interface Props {
  result: VisionResult;
  accentColor: string;
  onDone: (elapsed: number, result: VisionResult, note: string) => void;
  onPend: (elapsed: number) => void;
  onRetry: () => void;
}

export function SingleActionCard({ result, accentColor, onDone, onPend, onRetry }: Props) {
